import{i as e}from"./rolldown-runtime-Dd_uD5pT.js";import{n as t,t as n}from"./jsx-runtime-BpzPEenQ.js";import{t as r}from"./download-B5Xv2fK1.js";import{t as i}from"./file-chart-column-increasing-CqwhZ0sL.js";import{t as a}from"./printer-BSA-TX74.js";import{t as o}from"./trash-2-CqgJufr2.js";import{t as s}from"./api-CLiRfOMY.js";import{A as c,C as l,F as u,L as d,M as f,O as p,R as m,T as h,a as g,at as _,f as v,h as y,j as b,n as x,y as S}from"./index-CqvCckIR.js";var C=e(t(),1),w=n(),T=({children:e})=>(0,w.jsx)(`label`,{className:`block text-[11px] font-bold text-slate-500 mb-1.5 uppercase tracking-wider`,children:e}),E=({type:e=`text`,value:t,onChange:n,placeholder:r,className:i=``})=>(0,w.jsx)(`input`,{type:e,value:t,onChange:n,placeholder:r,className:`px-4 py-2 text-[13px] border border-slate-200 rounded-lg bg-white text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0097A7]/20 focus:border-[#0097A7] transition-all duration-200 hover:border-slate-300 shadow-sm ${i}`}),D=({status:e})=>(0,w.jsx)(`span`,{className:`px-2 py-0.5 rounded-full text-[11px] font-semibold ${{Draft:`bg-slate-100 text-slate-600`,Sent:`bg-blue-100 text-blue-700`,Accepted:`bg-emerald-100 text-emerald-700`,Rejected:`bg-red-100 text-red-600`}[e]??`bg-slate-100 text-slate-500`}`,children:e??`—`}),O=e=>e?new Date(e).toLocaleDateString(`en-IN`,{day:`2-digit`,month:`short`,year:`numeric`}):`—`,k=e=>{let t=parseFloat(e);return isNaN(t)?`—`:t.toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})},ee=e=>{let t=Math.round(parseFloat(e));return isNaN(t)?`—`:t.toLocaleString(`en-IN`)},A=e=>{let t=[``,`One`,`Two`,`Three`,`Four`,`Five`,`Six`,`Seven`,`Eight`,`Nine`,`Ten`,`Eleven`,`Twelve`,`Thirteen`,`Fourteen`,`Fifteen`,`Sixteen`,`Seventeen`,`Eighteen`,`Nineteen`];return e===0?`Zero`:e<20?t[e]:e<100?[``,``,`Twenty`,`Thirty`,`Forty`,`Fifty`,`Sixty`,`Seventy`,`Eighty`,`Ninety`][Math.floor(e/10)]+(e%10?` `+t[e%10]:``):e<1e3?t[Math.floor(e/100)]+` Hundred`+(e%100?` `+A(e%100):``):e<1e5?A(Math.floor(e/1e3))+` Thousand`+(e%1e3?` `+A(e%1e3):``):e<1e7?A(Math.floor(e/1e5))+` Lakh`+(e%1e5?` `+A(e%1e5):``):A(Math.floor(e/1e7))+` Crore`+(e%1e7?` `+A(e%1e7):``)},j=e=>`INR `+A(Math.round(parseFloat(e)||0)).toUpperCase()+` Only`,M=e=>{if(!e)return``;let t=new Date(e);return`${String(t.getDate()).padStart(2,`0`)}-${String(t.getMonth()+1).padStart(2,`0`)}-${t.getFullYear()}`},N=e=>(parseFloat(e)||0).toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2}),te=async e=>{let t={};try{t=((await s.get(`/api/customer-master`,{skipGlobalLoader:!0})).data?.data??[]).find(t=>t.id===e.customerId)??{}}catch{t={customerName:e.customer?.customerName??``}}let n=parseFloat(e.taxAmount)||0,r=!(e.taxType??``).toUpperCase().includes(`CGST`),i=r?n:0,a=r?0:n/2,o=r?0:n/2,c=[[t.address,t.address2,t.address3,t.address4].filter(Boolean).join(`,
`),[t.city,t.state,t.pinCode].filter(Boolean).join(` - `)].filter(Boolean).join(`,
`),l=e.details??[],u=[];if(l.length<=10)u.push({items:l,isFirst:!0,isLast:!0,max:10});else{u.push({items:l.slice(0,10),isFirst:!0,isLast:!1,max:10});let e=10;for(;e<l.length;){let t=l.slice(e,e+15);e+=15,u.push({items:t,isFirst:!1,isLast:e>=l.length,max:15})}}let d=u.length,f=e.paymentTerms?e.paymentTerms.split(`
`).map(e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`)):[`1. GST &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: As applicable at the time of delivery.`,`2. Payment : 100% advance along with PO, before delivery.`,`3. Validity &nbsp;&nbsp;: The offer is valid for 30 days from the date of offer.`,`4. Transportation / Insurance : At customer scope, necessary guidance can give by VELSON team.`],p=(t,n,r)=>t.map((t,r)=>`<tr>
      <td class="c">${n+r+1}</td>
      ...
      <td class="c">${t.uom??``}</td>
      <td class="r">${N(t.unitPrice)}</td>
      <td class="r">${N(t.amount)}</td>
    </tr>`).join(``)+Array(r-t.length).fill(`<tr class="blank"><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>`).join(``),m=()=>`
    <div class="terms">
      <div class="t-title">Terms &amp; Conditions :</div>
      ${f.map(e=>`<div class="t-line">${e}</div>`).join(``)}
    </div>`,h=e=>`
    <div class="pgfoot">
      ...
      <div class="pf-last">
        ...
        <span>Page ${e} of ${d}${e<d?`&nbsp;&nbsp;&nbsp;Continue(-.)`:``}</span>
      </div>
    </div>`,g=`${window.location.origin}/velson-logo.png`,_=0,v=u.map((n,r)=>{let s=_;_+=n.items.length;let l=n.isFirst?`
      <div class="doc-hdr">
      ...
      <table class="buyer-tbl"><tbody><tr>
        ...
        <td class="date-col">
          <div class="d-row"><span class="d-lbl">Date :</span><span>${M(e.quotationDate)}</span></div>
      ...
      <table class="bank-tbl"><tbody><tr>
        ...
        <td class="totals-right">
          <div class="t-row"><span class="t-lbl">VALUE :</span><span class="t-val">${N(e.subTotal)}</span></div>
          <div class="t-row"><span class="t-lbl">CGST Amount :</span><span class="t-val">${N(a)}</span></div>
          <div class="t-row"><span class="t-lbl">SGST Amount :</span><span class="t-val">${N(o)}</span></div>
          <div class="t-row"><span class="t-lbl">IGST Amount :</span><span class="t-val">${N(i)}</span></div>
          <div class="t-row"><span class="t-lbl">Frieght Charge :</span><span class="t-val">${N(e.freightAmount)}</span></div>
          <div class="t-row"><span class="t-lbl">Packing &amp; Forwarding Charge :</span><span class="t-val">${N(e.packingForwarding)}</span></div>
          <div class="t-row grand"><span class="t-lbl">TOAL VALUE :</span><span class="t-val">${N(e.totalAmount)}</span></div>
        </td>
      </tr></tbody></table>
      <div class="words">
        <div class="w-title">Amount chargeable in words</div>
        <div class="w-val">(${j(e.totalAmount)})</div>
...
</body></html>`,b=new Blob([y],{type:`text/html;charset=utf-8`}),x=URL.createObjectURL(b);window.open(x,`_blank`,`width=900,height=850`),setTimeout(()=>URL.revokeObjectURL(x),6e4)},ne=async e=>{let t={};try{t=((await s.get(`/api/customer-master`,{skipGlobalLoader:!0})).data?.data??[]).find(t=>t.id===e.customerId)??{}}catch{t={customerName:e.customer?.customerName??``}}let n=parseFloat(e.taxAmount)||0,r=parseFloat(e.taxPercent)||18,i=parseFloat(e.subTotal)||0,a=parseFloat(e.freightAmount)||0,o=parseFloat(e.packingForwarding)||0,c=i+a+o,l=!(e.taxType??``).toUpperCase().includes(`CGST`),u=l?n:0,d=l?0:n/2,f=l?0:n/2,p=l?0:r/2,m=l?0:r/2,h=l?r:0,g=[[t.address,t.address2,t.address3,t.address4].filter(Boolean).join(`,
`),[t.city,t.state,t.pinCode].filter(Boolean).join(` - `)].filter(Boolean).join(`,
...
<div class="page brk">
  ...
  <table class="bank-tbl"><tbody><tr>
    ...
    <td class="totals-right">
      <div class="t-row"><span class="t-lbl">Sub Total :</span><span class="t-val">${N(i)}</span></div>
      <div class="t-row"><span class="t-lbl">Frieght Charge :</span><span class="t-val">${N(a)}</span></div>
      <div class="t-row"><span class="t-lbl">Packing &amp; Forwarding Charge :</span><span class="t-val">${N(o)}</span></div>
      <div class="t-row"><span class="t-lbl">Taxable Value :</span><span class="t-val">${N(c)}</span></div>
      <div class="t-row"><span class="t-lbl">CGST (${p.toFixed(2)}%) :</span><span class="t-val">${N(d)}</span></div>
      <div class="t-row"><span class="t-lbl">SGST (${m.toFixed(2)}%) :</span><span class="t-val">${N(f)}</span></div>
      <div class="t-row"><span class="t-lbl">IGST(${h.toFixed(2)}%) :</span><span class="t-val">${N(u)}</span></div>
      <div class="t-row grand"><span class="t-lbl">TOAL VALUE :</span><span class="t-val">${N(e.totalAmount)}</span></div>
    </td>
  </tr></tbody></table>
  <div class="words">
...
</body></html>`,E=new Blob([T],{type:`text/html;charset=utf-8`}),D=URL.createObjectURL(E);window.open(D,`_blank`,`width=900,height=850`),setTimeout(()=>URL.revokeObjectURL(D),6e4)},re=async e=>{let t={};try{t=((await s.get(`/api/customer-master`,{skipGlobalLoader:!0})).data?.data??[]).find(t=>t.id===e.customerId)??{}}catch{t={customerName:e.customer?.customerName??``}}let n=parseFloat(e.taxAmount)||0,r=parseFloat(e.taxPercent)||18,i=parseFloat(e.subTotal)||0,a=parseFloat(e.freightAmount)||0,o=parseFloat(e.packingForwarding)||0,c=i+a+o,l=!(e.taxType??``).toUpperCase().includes(`CGST`),u=l?n:0,d=l?0:n/2,f=l?0:n/2,p=l?0:r/2,m=l?0:r/2,h=l?r:0,g=[[t.address,t.address2,t.address3,t.address4].filter(Boolean).join(`,
`),[t.city,t.state,t.pinCode].filter(Boolean).join(` - `)].filter(Boolean).join(`,
...
`).map(e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`)):[`1. GST &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: As applicable at the time of delivery.`,`2. Payment : 100% advance along with PO, before delivery.`,`3. Validity &nbsp;&nbsp;: The offer is valid for 30 days from the date of offer.`,`4. Transportation / Insurance : At customer scope, necessary guidance can give by VELSON team.`],x=()=>`
    ...
    </div>`,C=`${window.location.origin}/velson-logo.png`,w=0,T=v.map((n,r)=>{let s=r+1,l=n.isFirst,_=n.isLast,v=n.items.map(t=>(w++,`<tr>
        <td class="c">${w}</td>
        <td>${[t.itemName,t.partNo].filter(Boolean).join(`  `)}</td>
        <td class="c">${parseFloat(t.taxPercent??e.taxPercent??18).toFixed(2)}</td>
        <td class="c">${t.hsnCode??``}</td>
...
</body></html>`,D=new Blob([E],{type:`text/html;charset=utf-8`}),O=URL.createObjectURL(D);window.open(O,`_blank`,`width=900,height=850`),setTimeout(()=>URL.revokeObjectURL(O),6e4)},ie=async e=>{let t={};try{t=((await s.get(`/api/customer-master`,{skipGlobalLoader:!0})).data?.data??[]).find(t=>t.id===e.customerId)??{}}catch{t={customerName:e.customer?.customerName??``}}let n=parseFloat(e.taxAmount)||0,r=parseFloat(e.taxPercent)||18,i=parseFloat(e.subTotal)||0,a=parseFloat(e.specialDiscount)||0,o=i-a,c=!(e.taxType??``).toUpperCase().includes(`CGST`),l=c?n:0,u=c?0:n/2,d=c?0:n/2,f=c?0:r/2,p=c?0:r/2,m=c?r:0,h=[[t.address,t.address2,t.address3,t.address4].filter(Boolean).join(`,
`),[t.city,t.state,t.pinCode].filter(Boolean).join(` - `)].filter(Boolean).join(`,
...
`).map(e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`)):[`1. GST &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: As applicable at the time of delivery.`,`2. Payment : 100% advance along with PO, before delivery.`,`3. Validity &nbsp;&nbsp;: The offer is valid for 30 days from the date of offer.`,`4. Transportation / Insurance : At customer scope, necessary guidance can give by VELSON team.`],b=(t,n,r)=>t.map((t,r)=>`<tr>
    ...
    <div class="pgfoot">
    ...
    </div>`,C=`${window.location.origin}/velson-logo.png`,w=0,T=_.map((n,r)=>{let s=w;w+=n.items.length;let c=n.isFirst?`
      <div class="doc-hdr">
        <img src="${C}" alt="" onerror="this.style.display='none'"/>
        <span class="co-name">VELSON</span>
      </div>
      ...
      <table class="bank-tbl"><tbody><tr>
        ...
        <td class="totals-right">
          ...
          <div class="t-row"><span class="t-lbl">Dis Amount :</span><span class="t-val">${N(a)}</span></div>
          <div class="t-row sep"><span class="t-lbl">Sub Total :</span><span class="t-val">${N(o)}</span></div>
          ...
          <div class="t-row"><span class="t-lbl">CGST (${f.toFixed(2)}%) :</span><span class="t-val">${N(u)}</span></div>
          <div class="t-row"><span class="t-lbl">SGST (${p.toFixed(2)}%) :</span><span class="t-val">${N(d)}</span></div>
          <div class="t-row"><span class="t-lbl">IGST(${m.toFixed(2)}%) :</span><span class="t-val">${N(l)}</span></div>
          <div class="t-row grand"><span class="t-lbl">TOAL VALUE :</span><span class="t-val">${N(e.totalAmount)}</span></div>
        </td>
      </tr></tbody></table>
      <div class="words">
...
<div style="text-align:center;margin:10px 0">
...
</body></html>`,D=new Blob([E],{type:`text/html;charset=utf-8`}),O=URL.createObjectURL(D);window.open(O,`_blank`,`width=900,height=850`),setTimeout(()=>URL.revokeObjectURL(O),6e4)},ae=e=>{let t=(e.details??[]).map((e,t)=>`
    <tr>
  ...
  <div class="totals">
    ...
    <div class="grand">Grand Total: ${ee(e.totalAmount)}</div>
  </div>
